...
#        self.setBtnStates(state=DISABLED)
    ...
    def generateGCode(self):
        ...
        if (int(self.__CC.get()) == 3):
            cPoint = (
                float(self.__centerX.get()) - sizeAB[1],
                float(self.__centerY.get()) - sizeAB[0]
            )
    ...
    def __createGCodeRect(self, dir, cPoint,z,sizeAB, feeds):
        ...
        # start is #1
        millPos = {
            "#1" : "G01 X{0:08.3f} Y{1:08.3f} Z{2:08.3f} F{3:05.1f} {4}".format(
                    cPoint[0],
                    cPoint[1],
                    z,
                    feeds["XYGn"],
                    CR),
            "#2" : "G01 X{0:08.3f} Y{1:08.3f} Z{2:08.3f} F{3:05.1f} {4}".format(
                    cPoint[0],
                    cPoint[1] + sizeAB[0],
                    float(z),
                    feeds["XYGn"],
                    CR),
            "#3" : "G01 X{0:08.3f} Y{1:08.3f} Z{2:08.3f} F{3:05.1f} {4}".format(
                    cPoint[0] + sizeAB[1],
                    cPoint[1] + sizeAB[0],
                    float(z),
                    feeds["XYGn"],
                    CR),
            "#4" : "G01 X{0:08.3f} Y{1:08.3f} Z{2:08.3f} F{3:05.1f} {4}".format(
                    cPoint[0] + sizeAB[1],
                    cPoint[1],
                    float(z),
                    feeds["XYGn"],
