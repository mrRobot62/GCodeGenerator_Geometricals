...
class DrillHolesGrid(GeometricalFrame):
    ...
    def _frmIndividualContent(self):
        ...
        Label(
            self.frmButtonsIndividualContent, text="Drill diameter").grid(
                row=row, column=0, sticky=W)
        FloatEntry(
            self.frmButtonsIndividualContent,
            width=10,
        ...
        Label(
            self.frmButtonsIndividualContent, text="Retraction").grid(
                row=row, column=2, sticky=W)
        FloatEntry(
            self.frmButtonsIndividualContent,
            width=10,
            mandatory=False,
            textvariable=self.__retraction).grid(
        ...
        Label(
            self.frmButtonsIndividualContent, text="Grid Angle (W1)").grid(
                row=row, column=0, sticky=W)
        FloatEntry(
            self.frmButtonsIndividualContent,
            width=10,
            ...
            textvariable=self.__gridAngleW1).grid(
                row=row, column=1, sticky=W)
        Label(
            self.frmButtonsIndividualContent, text="ColOffset +X").grid(
                row=row, column=2, sticky=W)
        FloatEntry(
            self.frmButtonsIndividualContent,
            width=10,
        ...
        Label(
            self.frmButtonsIndividualContent,
            text="Distance between rows (a)").grid(
                row=row, column=0, sticky=W)
        FloatEntry(
            self.frmButtonsIndividualContent,
            width=5,
        ...
        Label(
            self.frmButtonsIndividualContent,
            text="Distance between columns (b)").grid(
                row=row, column=2, sticky=W)
        FloatEntry(
            self.frmButtonsIndividualContent,
            width=5,
    ...
    def generateGCode(self):
        ...
        hCPoints = self.createHoleCenterPointVectorList(
            cPoint, gSize, gridAngle, colOffsetX)
        ...
        for vc in hCPoints:
            nr += 1
            gc += self.drillSubHole(nr, gridAngle, vc, self.__dir.get(),
                                    indent, retraction)
            pass
    ...
    def createHoleCenterPointVectorList(self,
        ...
        cPointTemp = cPoint
        print(
            CR + "cPoint {0}, gSize {1}, gAngle {2:5.1f}, colOffsetX {3:5.1f}".
            format(cPoint, gSize, gAngle, colOffsetX))
...
# offset is only relevant for above rows !
    ...
    def drillSubHole(self,
        ...
        gc += indent + "G01 Z{0:08.3f} F{1:05.1f} {2}".format(startZ, FZ1, CR)
        ...
        gc += lgc
        # start Z
        gc += indent + "G00 Z{0:08.3f} F{1:04.0f} {2}".format(startZ, FZ0, CR)
    ...
    def userInputValidation(self):
        ...
        if (a <= toolDia or b <= toolDia):
            self.MessageBox(
                state="ERROR",
                title="WARN",
                text="distance A or B is less than tool diameter {}".format(
                    toolDia))
            return False
